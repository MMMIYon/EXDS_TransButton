    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                /*    射击 格斗 喷射 切锁 副射 特射 特格 觉醒 通信 test 刷卡 无    */
                #region 框
                if (fangkuang == "射击")
                {
                    TempT = "1,";
                ...
                else if (fangkuang == "格斗")
                {
                    TempT = "1,";
                    B += TempT;
                }
                else if (fangkuang == "喷射")
                {
                    TempT = "1,";
                    C += TempT;
                }
                else if (fangkuang == "切锁")
                {
                    TempT = "1,";
                    D += TempT;
                }
                else if (fangkuang == "副射")
                {
                    TempT = "1,";
                    A += TempT;
                    B += TempT;
                }
                else if (fangkuang == "特射")
                {
                    TempT = "1,";
                    A += TempT;
                    C += TempT;
                }
                else if (fangkuang == "特格")
                {
                    TempT = "1,";
                    B += TempT;
                    C += TempT;
                }
                else if (fangkuang == "觉醒")
                {
                    TempT = "1,";
                    A += TempT;
                    B += TempT;
                ...
                else if (fangkuang == "刷卡")
                {
                    TempT = "1,";
                    CD += TempT;
                }
                else if (fangkuang == "投币")
                {
                    TempT = "1,";
                    CO += TempT;
                }
